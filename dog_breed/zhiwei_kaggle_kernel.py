...
WIDTH = 299
N_CLASS = 120
A = dict(train_image="../input/stanford-dog/stanford_dog/stanford_dog/images", seed=7, stanford=True)
...
def main():
    ...
    model_checkpoint = dict(filepath='./{val_loss:.5f}_{loss:.5f}_{epoch:04d}.weights.h5',
                            save_best_only=True,
    ...
    for i in tqdm(range(n_test)):
        img = cv2.imread('../input/dog-breed-identification/test/%s.jpg' % df2['id'][i])
